...
const size_cpanel_controller_1 = require("./size.cpanel.controller");
    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: size_schema_1.Size.name, schema: size_schema_1.SizeSchema },
            ]),
        ],
        controllers: [size_controller_1.SizeController, size_cpanel_controller_1.SizesCpanelController],
