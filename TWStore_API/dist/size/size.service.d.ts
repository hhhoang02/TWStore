...
export declare class SizeService {
    ...
    AddSize(requestDTO: SizeAddRequestDTO): Promise<SizeResponseDTO>;
    GetAllSize(): Promise<SizeGetAllResponseDTO[]>;
    DeleteSize(requestDTO: SizeDeleteRequestDTO): Promise<SizeResponseDTO>;
}
